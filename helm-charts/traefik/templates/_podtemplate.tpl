    ...
    spec:
      ...
      - image: {{ template "traefik.image-name" . }}
        ...
        args:
          ...
          - "--experimental.localPlugins.vumiddleware.moduleName=vunetsystems/user-engagement"
          {{- if $.Values.experimentalPlugins.ipLinkedCookie.enabled }}
          - "--experimental.localPlugins.ipLinkedCookie.moduleName=vunetsystems/ip-linked-cookie"
          {{- end }}
          {{- if .Values.metrics }}
